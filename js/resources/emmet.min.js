...
{var extracto=document.createDocumentFragment();sentencia+=";";var tabladesignos=sentencia.match(/[#|\.|\w|\{|\(][\w|\[|\]|\{|\}|\=|\s|\$|\-|\_|\(|\)|\#|\.|\@|\,|&|ñ|%|:|/|\\|?]*[>|^|\+|*|;]+/g);var proximosigno=">";var ultimoelemento=extracto;var insidemultipl=0;var tablainside=[];var elemento="";var nodoprimario="";var altura=1;for(var a=0;a<tabladesignos.length;a++)
